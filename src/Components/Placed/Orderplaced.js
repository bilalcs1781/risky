        ...
        {loading ? (
          ...
          <div className="col-12 d-flex flex-column  align-items-center mb-5">
            ...
            <p className="text-center mt-3" style={{ lineHeight: "35px" }}>
              ...
              <br />
              <span className="fs-5" style={{ fontFamily: "Times New Roman" }}>
                Order Tracking ID is: <b>{filterOrder[0].orderId}</b>
              </span>{" "}
              <br />
              <span className="fs-5" style={{ fontFamily: "Times New Roman" }}>
                Order will be delivered within 05-07 working days. We will
                update you soon.
              </span>
            </p>
          ...
          >
            ...
            <a href="/Products/all">
              <button className="button-submit px-5">Shop our products</button>
            </a>
          </div>
        )}
      </div>
