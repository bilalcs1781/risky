...
const CheckoutForm = () => {
  ...
  const sendWhatsAppMessage = () => {
    ...
    const whatsappURL = `https://wa.me/+447392608087?text=${encodeURIComponent(
      message
    )}`;
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`${process.env.REACT_APP_BASE_URL}/checkout?userId=${userId}`)
      .then((res) => {
        try {
          if (res) {
            // dispatch({
      ...
      <div className="container-fluid ">
        <div className="row checkout_display d-flex justify-content-center my-lg-3">
          {loading ? (
            ...
            <>
              <div
                className="col-lg-6 col-md-6 col-sm-12 py-3 px-3 mt-3 mt-lg-0 "
                style={{
                  backgroundColor: "white",
                  borderRight: "1px solid lightgray",
                }}
              >
                <h4 className="mb-3 fw-bolder" style={{}}>
                  Delivery Details
                </h4>
                <form action="" onSubmit={handleSubmit(Order)}>
                  ...
                  {filterCart?.length > 0 && (
                    <div className="chk_btns chk_btns1 mt-5">
                      <button
                        className="fw-bolder btn btn-lg"
                        style={{
                          width: "100%",
              ...
              <div className="col-lg-4 col-md-6 col-sm-12 px-4 pt-5 pt-lg-3">
                ...
                <div
                  className="row mt-3 py-3 border"
                ...
                >
                  ...
                  <div
                    className="px-3 col-12 d-flex justify-content-between align-items-center"
            ...
            <div
              className="col-lg-4 col-md-6 col-sm-12 px-4 pt-5 pt-lg-3 d-flex flex-column justify-content-center align-items-center"
              style={{ height: "50vh" }}
            >
