...
const SingleAdd = () => {
  ...
  const sendWhatsAppMessage = () => {
    ...
    const whatsappURL = `https://wa.me/+923067208343?text=${encodeURIComponent(
      message
    )}`;
    ...
    const fetchData = async () => {
      try {
        ...
        const resp = await axios.get(
          `${process.env.REACT_APP_BASE_URL}/singleProduct?id=${productId}`,
  ...
  const handleShare = async (platform) => {
    ...
    if (copiedSuccessfully) {
      ...
      toast.error(
        "Failed to copy URL. Please try again or manually copy the URL."
      );
    }
    switch (platform) {
      case "general":
  ...
  async function AddToCart(product, totalPrice, color, size) {
  ...
  async function Order() {
    await AddToCart(product, totalPrice, size, color);
  ...
  const Comment = async (cmnt) => {
    ...
    if (cmnt.image && cmnt.image[0]) {
      ...
      try {
        const response = await axios.post(
          "https://api.cloudinary.com/v1_1/dlw9hxjr4/image/upload",
          formData
        );
    ...
    if (cmnt.video && cmnt.video[0]) {
      ...
      try {
        ...
        const response = await axios.post(
          "https://api.cloudinary.com/v1_1/dlw9hxjr4/video/upload",
          formData
        );
        mediaUrl = response.data.url;
        reset();
      ...
      {loading ? (
        ...
        <div className="container-fluid min-vh-100">
          <div className="row">
            ...
            <div
              className="col-lg-1 col-md-2 col-sm-12 order-lg-1 order-md-1 order-2 p-0 m-0 d-flex flex-column align-items-center"
            ...
            <div
              className="col-lg-5 col-md-8 col-sm-12 order-lg-2 order-md-2 order-1 mb-lg-5 mb-2"
            ...
            <div
              className="col-lg-5 col-sm-12 order-3"
            ...
            >
              ...
              <div className="d-flex mt-3">
                <p className="fs-6 fw-bolder">🌟 3-4 Days - </p>
                <p className="text-muted"> Fast-Delivery</p>
              </div>
              <div className="d-flex">
                <p className="fs-6 fw-bolder ">🌟 7 Days - </p>
                <p className="text-muted"> Warrenty Replacements</p>
              </div>
              <div className="d-flex">
                <p className="fs-6 fw-bolder ">🌟 24/7 - </p>
                <p className="text-muted"> Customer Support</p>
              </div>
              <div className="mt-3 d-flex flex-wrap gap-3">
                <p
                  className="m-0 d-flex align-items-center cursor"
                  style={{
                    fontSize: "17px",
                    fontWeight: "600",
                  }}
                ...
                <p
                  className="m-0 fs-6 d-flex justify-content-center align-items-center cursor"
              ...
              <button
                className="s_whatsapp fw-bolder"
          ...
          <div className="row mt-5 mb-3 d-flex justify-content-center">
            <div className="col-lg-10 col-md-10 col-sm-12">
              <p className="fs-2 fw-bolder">Size Chart</p>
          ...
          <div className="row mt-5 d-flex justify-content-center">
            <div className="col-lg-10 col-md-10 col-sm-12">
              <p className="fs-3 fw-bolder">Related Products</p>
              {loading ? (
                <div
                  className="col-lg-12 col-sm-12 d-flex align-items-center justify-content-center"
                  style={{ height: "80vh" }}
                  ...
                  {data
                    ...
                    .map((item, index) => (
                      <div className="col card" key={index}>
                        <a
                          href={`/product/${item.title.replace(/ /g, "-")}/${
                            item._id
                          }`}
                        >
                ...
                >
                  <div className="border p-5 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p className="text-center fs-5">
                      No review yet. Any feedback? Let us know{" "}
                    </p>
                    <div className="">
                      <button
                        className="button-submit px-3"
                          ...
                          <div className="modal-body p-3">
                            <form action="" onSubmit={handleSubmit(Comment)}>
                              ...
                              <div className="d-flex gap-2 mb-3">
                                ...
                                {imageSelected && (
                                  <p className="text-success">Image Selected</p>
                                )}
                                {videoSelected && (
                                  <p className="text-success">Video Selected</p>
                                )}
                              </div>
