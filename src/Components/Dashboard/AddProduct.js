...
export const AddProduct = () => {
  ...
  useEffect(() => {
    try {
      if (productId) {
        axios
          .get(`${process.env.REACT_APP_BASE_URL}/product_edit?id=${productId}`)
          .then(function (resp) {
    ...
    if (productId) {
      ...
      try {
        const response = await axios.put(
          `${process.env.REACT_APP_BASE_URL}/product-update`,
          data
        );
        setLoading(false);
        ...
        if (
          ...
          error.response.data.message === "Cannot add more than 10 images"
        ) {
        ...
        <div className="row border py-5 px-4">
          <div className="col-lg-12 col-sm-12">
            <div className="d-flex justify-content-between">
              {!product && <h1 className="p_head fw-bolder"> Add Product </h1>}
              {product && <h1 className="p_head fw-bolder"> Edit Product </h1>}
            ...
            {Error === "images" && (
              <div className="error">
                Invalid number of images. Must be between 1 and 10
              </div>
            )}
            {loading ? (
              <div
                ...
                <div className="row">
                  <div className="col-lg-6  col-md-6 col-sm-12  my-2">
                    ...
                    <input
                      ...
                      className="form-control mb-2 mr-sm-2 border"
                    />
                  ...
                  <div className="col-lg-6  col-md-6 col-sm-12  my-2">
                    ...
                    <input
                      type="number"
                      {...register("sn", { required: true })}
                      min={"1"}
                      className="border form-control mb-2 mr-sm-2"
                    />
                    {errors.sn && errors.sn.type == "required" ? (
                      <div className="error">Serail Number is required</div>
                    ) : null}
                  </div>
                  ...
                  <div className="col-lg-6  col-md-6 col-sm-12  my-2">
                    ...
                    <select
                      {...register("category", {
                        required: true,
                        validate: function (selectedValue) {
                  ...
                  <div className="col-lg-6  col-md-6 col-sm-12 my-2">
                    ...
                    {errors.images && errors.images.type === "maxLength" && (
                      <div className="error">Only Ten images allowed</div>
                    )}
