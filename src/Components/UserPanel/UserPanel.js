          ...
          <div className="col-lg-4 col-md-4 col-sm-12">
            <div className="card mb-4">
              <div className="card-body text-center">
                ...
                <button
                  type="button"
                  className="button-submit px-5 ms-1 my-3"
                  style={{ width: "100%" }}
                  onClick={Logout}
                >
                  Logout
          ...
          <div className="col-lg-8 col-md-8 col-sm-12">
            <div className="d-flex gap-5 mb-4">
              <button
                className={`profile_btn ${
                  component === "orders" ? "button-submit px-4" : ""
                }`}
              ...
              <button
                className={`profile_btn ${
                  component === "review" ? "button-submit px-4" : ""
                }`}
            ...
            {component === "orders" && (
              <>
                {isLoading ? (
                  <div
                    className="col-lg col-sm-12 d-flex align-items-center justify-content-center"
                    style={{ height: "50vh" }}
                  >
                    <Loader />
                  </div>
                  ...
                  <>
                    <p
                      className="fs-5 fw-bolder m-0"
                      style={{ color: "#1b2950" }}
                    >
                      Orders : {filterOrder?.length}
                    </p>
                  ...
                  <div
                    className="py-0 my-5 d-flex flex-column align-items-center justify-content-center gap-3"
                    style={{ minHeight: "100vh", backgroundColor: "#eee" }}
                  >
                    <p className="fw-bolder text-muted">No Order Placed yet</p>
                    <Lottie
                      animationData={userPanel}
                      loop={true}
                      style={{ width: "100%", height: "100%" }}
                    />
                    <button
                      className="button-submit px-5 py-3 w-100"
            ...
            {component === "review" && (
              <>
                <div className="h_box_main">
                  {loading ? (
                  ...
                  ) : comments?.filter((item) => item.userId === cu._id)
                      .length === 0 ? (
                    <div
                      className="col-lg-12 col-sm-12 d-flex align-items-center justify-content-center"
                      style={{ height: "50vh" }}
                    ...
                    comments
                      ?.filter((data) => data.userId === cu._id)
                      .map((item, index) => {
                        return (
                          <>
                            <div
